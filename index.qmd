...
When rendering the card, Typst only loads a variable font's *default* (usually
light) instance, so bold titles render thin. List the weights you need in the
font entry so Quarto fetches real static faces:
